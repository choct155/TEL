...
\begin{centering}
$$BaseVal_t = BaseStock_t + AvgValue_t$$
\par\end{centering}
...
in year$t$. JUST GO WITH STOCK (NOT BASE)...
...
to residential or non-residential) in year$t$.
\end{description}
NEED TO TALK ABOUT THE LIMITATIONS OF BACKING INTO THIS (TALK ABOUT
LACK OF EXEMPTIONS)

IS THERE AN ASSESSMENT/SALES RATIO ANALYSIS FOR COLORADO? ADD FACTOR
TO FORMULA...
\end{algorithm}
...
variables.
\begin{description}
\item [{$\bf{intensity_flow}$}] is the\emph{single-year} difference, percentage
...
DISCUSS FURTHER WHAT SPATIAL LAGS MEAN IN THE CONTEXT OF FIXED OR
RANDOM EFFECTS. WHY DIDN'T I USE FIXED OR RANDOM EFFECTS?
\end{figure}
...
process and confluent relations, it would be more to the point to\emph{think
of these econometric calculations themselves as observations of the
confluent relations}. As such they may be illuminating or useful or
neither, but not valid or invalid.''\citep{Hoover1994} (emphasis
added)
\end{quotation}
...
\item [{DEMARCATE}] VARIABLES OF INTEREST
